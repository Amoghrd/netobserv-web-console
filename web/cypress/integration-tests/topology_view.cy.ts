import { displayDropdownSelectors, genSelectors, netflowPage, topologySelectors, setupTopologyViewWithNamespaceFilter } from "@views/netflow-page"
...
describe("(OCP-53591 Network_Observability) Netflow Topology view features", { tags: ['Network_Observability'] }, function () {
    ...
    it("(OCP-53591, memodi, Network_Observability) should verify topology page features", function () {
